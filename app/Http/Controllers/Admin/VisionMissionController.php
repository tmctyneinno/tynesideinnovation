...
{  
    public function index(){ 
        return view('admin.pages.contents.vision_mission.index');
    }
    ...
    { 
        try {
            ...
            return redirect()->back()->with('success', 'Vision Mission statement added successfully.');
            
        } catch (ValidationException $e) {
            return redirect()->back()->withErrors($e->validator->errors())->withInput();
        } catch (QueryException $e) {
            return redirect()->back()->with('error', 'Failed to add Vision Mission statement statement. Please try again.');
        } catch (\Exception $e) {

                                ...
                                <table class="table align-middle table-nowrap" id="menuTable">
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr>
                                            ...
                                            <td class="menu_name">{{ $blog->title }}</td>
                                            <td class="menu_name">{!! Str::limit($blog->content, 30) !!}</td> 
                                            <td>
                                                <img src="{{ asset($blog->image) }}" class="img-thumbnail" height="30" alt="{{ $blog->title }}"  style="max-width: 100px;"/>
                                            </td>
                                            <td class="menu_name">{{ \Carbon\Carbon::parse($blog->created_at)->format('d M Y') }}</td> 

                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <a href="{{ route('admin.blog.edit',  encrypt($blog->id) ) }}" class="btn btn-sm btn-success edit-item-btn" >Edit</a>
                                                    </div>
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" data-bs-toggle="modal" data-bs-target="#deleteRecordModal{{ $blog->id }}" data-id="{{ $blog->id }}">Remove</button>
                                        ...
                                        {{-- Delete --}}
                                        <div class="modal fade zoomIn" id="deleteRecordModal{{ $blog->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="mt-2 text-center">
                                                            ...
                                                            <div class="mt-4 pt-2 fs-base mx-4 mx-sm-5">
                                                                <h4>Are you Sure ?</h4>
                                                                <p class="text-muted mx-4 mb-0">Are you sure you want to remove this blog?</p>
                                                            </div>
                                                        </div>
        ...
        <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <form class="tablelist-form"  method="POST" action="{{ route('admin.blog.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            <div class="mb-3">

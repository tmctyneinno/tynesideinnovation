            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="card-title mb-0"> Edit & Update Navigation Blog</h4>
                        <a href="{{ route('admin.blog.index')}}" class="btn btn-primary"> Blog List</a>
                    </div>
                    <!-- end card header -->
                                ...
                                <form method="POST"  action="{{ route('admin.blog.update', $blog->id) }}" enctype="multipart/form-data">
                                    ...
                                    @method('PUT')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Title" value="{{ $blog->title }}" name="title" id="title" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="labelInput" class="form-label">Content</label>
                                            <textarea type="text" class="ckeditor-classic" placeholder="Answer" name="content" id="content" required>{{ $blog->content }}</textarea>
                                        </div>
                                        <div class="mb-3 row ">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                @enderror
                                                <img src="{{ asset($blog->image) }}" alt="{{ $blog->title }}" class="img-thumbnail mt-2" width="200">

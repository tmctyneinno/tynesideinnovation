            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <h4 class="card-title mb-0"> Edit & Update Navigation Service</h4>
                        <a href="{{ route('admin.service.index')}}" class="btn btn-primary"> Service List</a>
                    </div>
                    <!-- end card header -->
                                ...
                                <form method="POST"  action="{{ route('admin.service.update', $service->id) }}" enctype="multipart/form-data">
                                    ...
                                    @method('PUT')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Title" value="{{ $service->title }}" name="title" id="title" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="labelInput" class="form-label">Content</label>
                                            <textarea type="text" class="ckeditor-classic" placeholder="Answer" name="content" id="content" required>{{ $service->content }}</textarea>
                                        </div>
                                        <div class="mb-3 row ">

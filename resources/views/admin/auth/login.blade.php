@extends('admin.adminLayout.adminLogin')
@section('title')
                                ...
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5 m-lg-4">
                                        <div class="text-center mt-5">
                                            ...
                                            <p class="text-muted">Sign in to continue with Tyneside Innovation.</p>
                                        </div>
                                        <div class="p-2 mt-5">
                                            <form action="{{ route('admin.login.submit')}}" method="post">
                                                ...
                                                <div class="mb-3">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="username"  name="email" value="{{ old('email', 'admin@gmail.com') }}" placeholder="Enter username">
                                                        @error('email')
                                    ...
                                    <div class="card-body py-5 d-flex justify-content-between flex-column">
                                        ...
                                        <div class="auth-effect-main my-5 position-relative rounded-circle d-flex align-items-center justify-content-center mx-auto">
                                            <div class="auth-user-list list-unstyled">
                                                <img src="{{ URL::asset('backend/images/auth/signin.png')}}" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <p class="text-white opacity-75 mb-0 mt-3">
                                                ...
                                                </script> Tyneside Innovation. Owned  <i class="ti ti-heart-filled text-danger"></i> <a style="color: red" href="https://morgansconsulting.ng/"> by Morgans Consulting </a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
<script src="{{ URL::asset('backend/js/pages/password-addon.init.js') }}"></script>
<script src="{{ URL::asset('backend/libs/swiper/swiper-bundle.min.js') }}"></script>
<script src="{{ URL::asset('backend/js/pages/swiper.init.js') }}"></script>
